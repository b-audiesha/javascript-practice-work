...
function secondToLast(sq) {
  return sq[sq.length -2];
}
...
function thirdToLast(sq) {
  return sq[sq.length -3];
}
...
function mean(sequence){
  return sequence.reduce((a,b) => a + b ) / sequence.length;
}
...
function getHighestNumber(numSQ) {
  return Math.max(...numSQ);
}
...
function getSmallestNumber(numSQ) {
  return Math.min(...numSQ);
}
...
function onlyOddNumbers(sequence) {
  return sequence.filter((element) => element % 2 !== 0);
}
...
function onlyPositiveNumbers(sequence) {
  return sequence.filter((element) => element > 0);
}
...
function hasEvens(sequence) {
  let evens = sequence.filter((element) => element % 2 === 0);
...
function countOdds(num) {
  return num.filter((element) => element % 2 !== 0).length;
}
...
function countNegatives(num) {
  return num.filter((element) => element < 0).length;
}
...
function onlyPositiveEvens(sequence) {
  return sequence.filter((element) => element > 0 && element % 2 === 0);
}
...
// had to copy this one, ask about it later
...
function getNumberOfBooks(objects) {
...
function totalOfBookPrices(booksArray) {
  let total = 0;
